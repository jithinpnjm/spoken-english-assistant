...
export const a1StudyBookTopicIndex: A1StudyBookTopicIndexEntry[] = [
  ...
  { id: "greetings-goodbyes", title: "Greetings and goodbyes", stage: "survival", lessonNos: [1], pageRefs: [{ batchId: "batch01", pdfPageNumber: 1 }, { batchId: "batch01", pdfPageNumber: 2 }, { batchId: "batch01", pdfPageNumber: 5 }] },
  ...
  { id: "germany-city-professions", title: "Germany questions, city places and professions", stage: "identity", lessonNos: [17, 18], pageRefs: [{ batchId: "batch02", pdfPageNumber: 1 }, { batchId: "batch02", pdfPageNumber: 2 }, { batchId: "batch01", pdfPageNumber: 20 }, { batchId: "batch01", pdfPageNumber: 21 }, { batchId: "batch02", pdfPageNumber: 3 }, { batchId: "batch02", pdfPageNumber: 4 }] },
  ...
  { id: "non-separable-verbs", title: "Non-separable verbs and verb patterns", stage: "grammar", lessonNos: [42], pageRefs: [{ batchId: "batch07", pdfPageNumber: 1 }, { batchId: "batch06", pdfPageNumber: 8 }, { batchId: "batch07", pdfPageNumber: 2 }] },
