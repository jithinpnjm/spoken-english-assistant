...
export const germanA1BookLessonsPart02: GermanA1BookLesson[] = [
  {
    ...
    introduction: "In German, numbers from 21 onwards are spoken 'backwards' compared to English: you say the unit first, then the tens. This is the biggest hurdle for beginners when paying at the supermarket or writing down a date of birth. Mastering this mental flip is essential for daily financial and temporal transactions.",
    theRule: [
    ...
    modelSentences: [
      {
        ...
        breakdown: "Das(That/demonstrative pronoun) kostet(costs/verb pos 2) fünfundvierzig(five-and-forty/number) Euro(euros/masculine noun)."
      },
      {
        de: "Meine Oma ist dreiundachtzig Jahre alt.",
        en: "My grandma is eighty-three years old.",
        breakdown: "Meine(My/possessive pronoun) Oma(grandma/feminine subject) ist(is/verb pos 2) dreiundachtzig(three-and-eighty/number) Jahre(years/plural noun) alt(old/adjective)."
      },
      {
        de: "Der Zug hat zweiundsechzig Minuten Verspätung.",
        en: "The train has a sixty-two minute delay.",
        breakdown: "Der(The/masculine article) Zug(train/masculine subject) hat(has/verb pos 2) zweiundsechzig(two-and-sixty/number) Minuten(minutes/plural noun) Verspätung(delay/feminine noun)."
      },
      {
        de: "Wie viel kostet das Brot?",
        en: "How much does the bread cost?",
        breakdown: "Wie(How) viel(much) kostet(costs/verb pos 2) das(the/neuter article) Brot(bread/neuter subject)?"
      }
    ],
  ...
  },
  {
    ...
    introduction: "In Germany, names, streets, and email addresses are frequently spelled out over the phone or at administrative desks. Since several German letters sound dangerously close to completely different English letters, learning the German alphabet is a vital survival skill to ensure you receive your mail and documents.",
    theRule: [
    ...
    modelSentences: [
      {
        ...
        breakdown: "Können(Can/modal verb) Sie(you/formal subject) das(that/neuter pronoun) bitte(please) buchstabieren(spell/infinitive verb)?"
      },
      {
        de: "Mein Nachname ist Meier: M - E - I - E - R.",
        en: "My last name is Meier: M - E - I - E - R.",
        breakdown: "Mein(My/possessive) Nachname(last name/masculine subject) ist(is) Meier: M - E(pronounced 'eh') - I(pronounced 'ee') - E - R."
      },
      {
        de: "Wie schreibt man das?",
        en: "How do you write that?",
        breakdown: "Wie(How) schreibt(writes/verb pos 2) man(one/impersonal subject) das(that)?"
      },
      {
        de: "Müller, mit M - Ü - L - L - E - R.",
        en: "Müller, with M - Ü - L - L - E - R.",
        breakdown: "Müller(last name), mit(with/dative preposition) M - Ü(U-umlaut) - L - L - E - R."
      }
    ],
  ...
  },
  {
    ...
    introduction: "Whether meeting new colleagues, making friends, or starting an exam, introducing yourself is the foundation of human connection. In German, there are highly structured, standardized verbs for expressing your name, origin, and current residence. Mastering these provides a confident launchpad for any conversation.",
    theRule: [
    ...
    modelSentences: [
      {
        ...
        breakdown: "Guten(Good) Tag(day), ich(I/subject) heiße(am called/verb pos 2) Thomas Müller."
      },
      {
        de: "Ich komme aus Italien.",
        en: "I come from Italy.",
        breakdown: "Ich(I/subject) komme(come/verb pos 2) aus(from/dative preposition) Italien(Italy)."
      },
      {
        de: "Ich wohne jetzt in Frankfurt.",
        en: "I live in Frankfurt now.",
        breakdown: "Ich(I/subject) wohne(live/verb pos 2) jetzt(now/time adverb) in(in/preposition) Frankfurt."
      },
      {
        de: "Ich komme aus der Türkei, aber ich wohne in Köln.",
        en: "I come from Turkey, but I live in Cologne.",
        breakdown: "Ich komme aus der(the/dative article for feminine country) Türkei(Turkey), aber(but/conjunction) ich(I) wohne(live) in Köln."
      }
    ],
    ...
    commonMistakes: [
      {
        ...
        explanation: "English speakers often try to translate 'I am called' literally by using 'bin' (am) and 'heiße' together. 'Heißen' is an independent verb; it doesn't need 'bin'."
      },
      {
        wrong: "Ich komme von Spanien.",
        right: "Ich komme aus Spanien.",
        explanation: "To express geographic origin (where you were born/raised), always use 'aus', never 'von'."
      }
    ],
    skyPracticePrompts: [
  ...
  },
  {
    ...
    introduction: "A conversation is a two-way street. Once you introduce yourself, you must be able to ask the other person about themselves. In German, this requires understanding the crucial difference between the formal 'Sie' (used with strangers) and the informal 'du' (used with friends), as well as changing the verb endings to match.",
    theRule: [
    ...
    modelSentences: [
      {
        ...
        breakdown: "Wie(How) heißen(are called/verb pos 2 with -en ending) Sie(you/formal subject)?"
      },
      {
        de: "Woher kommst du?",
        en: "Where do you come from? (Informal)",
        breakdown: "Woher(Where from/question word) kommst(come/verb pos 2 with -st ending) du(you/informal subject)?"
      },
      {
        de: "Wo wohnen Sie?",
        en: "Where do you live? (Formal)",
        breakdown: "Wo(Where/question word) wohnen(live/verb pos 2 with -en ending) Sie(you/formal subject)?"
      },
      {
        de: "Welche Sprachen sprichst du?",
        en: "Which languages do you speak? (Informal)",
        breakdown: "Welche(Which) Sprachen(languages) sprichst(speak/irregular verb with -st ending) du(you)?"
      }
    ],
  ...
  },
  {
    ...
    titleEn: "How are you?",
    titleDe: "Wie geht's?",
    introduction: "In English, 'How are you?' is often just a casual greeting. In German, 'Wie geht es dir?' is a genuine inquiry into someone's well-being. Germans don't use it to just say hello to strangers passing by. When you ask this, be prepared for an honest answer—and know how to give one yourself using the Dative case.",
    theRule: [
      "The phrase 'How are you?' translates literally to 'How goes it to you?'. Therefore, you must use Dative pronouns.",
    ...
    modelSentences: [
      {
        ...
        breakdown: "Guten Tag Frau Schmidt, wie(how) geht(goes/verb pos 2) es(it/subject) Ihnen(to you/formal dative pronoun)?"
      },
      {
        de: "Hallo Tom, wie geht's?",
        en: "Hello Tom, how's it going?",
        breakdown: "Hallo Tom, wie geht(goes)'s(contraction of 'es')?"
      },
      {
        de: "Danke, mir geht es sehr gut. Und dir?",
        en: "Thanks, I am doing very well. And you?",
        breakdown: "Danke, mir(to me/dative pronoun) geht(goes) es(it) sehr(very) gut(good). Und(And) dir(to you)?"
      },
      {
        de: "Mir geht es nicht so gut.",
        en: "I am not doing so well.",
        breakdown: "Mir geht es nicht(not) so(so) gut(good)."
      }
    ],
    ...
    commonMistakes: [
      {
        ...
        explanation: "Saying 'Ich bin gut' means 'I am a good person' or 'I am highly skilled'. To express feeling well, you MUST use 'Mir geht es gut'."
      },
      {
        wrong: "Wie geht du?",
        right: "Wie geht es dir?",
        explanation: "You cannot translate 'how are you' word-for-word. You must use the 'es geht' + dative construction."
      }
    ],
    skyPracticePrompts: [
    ...
    lessonGoal: "Correctly ask about someone's well-being in both formal and informal situations, and reply accurately using Dative pronouns."
  },
  {
    lessonNo: 9,
    titleEn: "Sentence Structure Part 1",
    titleDe: "Satzbau Teil 1",
    introduction: "In German, the verb must always come in second position, even if you start with something other than the subject. This is the absolute most important rule in A1 grammar because every single statement you speak or write depends on it. If you master this rule early, your German will instantly sound natural and correct.",
    theRule: [
    ...
    modelSentences: [
      {
        ...
        en: "I drink coffee.",
        breakdown: "Ich(I/subject, pos 1) trinke(drink/verb, pos 2) Kaffee(coffee/object, pos 3)."
      },
      {
        de: "Der Mann lernt Deutsch.",
        en: "The man is learning German.",
        breakdown: "Der Mann(The man/subject block, pos 1) lernt(learns/verb, pos 2) Deutsch(German/object, pos 3)."
      },
      {
        de: "Wir machen einen Kurs.",
        en: "We are doing a course.",
        breakdown: "Wir(We/subject, pos 1) machen(do/verb, pos 2) einen Kurs(a course/accusative object, pos 3)."
      },
      {
        de: "Die Frau kauft das Wasser.",
        en: "The woman buys the water.",
        breakdown: "Die Frau(The woman/subject block, pos 1) kauft(buys/verb, pos 2) das Wasser(the water/object, pos 3)."
      }
    ],
    ...
    exercises: [
      ...
      },
      {
        ...
        items: [
          { prompt: "Ich ___ (trinken) Wasser.", answer: "trinke", hint: "verb pos 2, 'ich' ending" },
          { prompt: "Der Mann ___ (essen) Brot.", answer: "isst", hint: "verb pos 2, irregular 'er' form" }
        ]
      }
    ],
    commonMistakes: [
  ...
  },
  {
    ...
    introduction: "To avoid sounding like a robot (I do this. I go there. I eat that.), you need to start sentences with different words, like times or places. But here is the catch: when you start a sentence with 'Today' or 'Here', the verb STILL stays in position 2. This forces the subject to jump to position 3. This is called 'Inversion'.",
    theRule: [
    ...
    modelSentences: [
      {
        ...
        breakdown: "Heute(Today/Time, pos 1) spiele(play/Verb, pos 2) ich(I/Subject, pos 3) Fußball(soccer/Object, pos 4)."
      },
      {
        de: "Jetzt trinken wir Kaffee.",
        en: "Now we are drinking coffee.",
        breakdown: "Jetzt(Now/Time, pos 1) trinken(drink/Verb, pos 2) wir(we/Subject, pos 3) Kaffee(coffee/Object, pos 4)."
      },
      {
        de: "Hier arbeitet mein Vater.",
        en: "My father works here.",
        breakdown: "Hier(Here/Place, pos 1) arbeitet(works/Verb, pos 2) mein Vater(my father/Subject block, pos 3)."
      },
      {
        de: "Morgen kauft sie ein Auto.",
        en: "Tomorrow she is buying a car.",
        breakdown: "Morgen(Tomorrow/Time, pos 1) kauft(buys/Verb, pos 2) sie(she/Subject, pos 3) ein Auto(a car/Object, pos 4)."
      }
    ],
